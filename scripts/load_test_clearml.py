...
def send_request(
    ...
    """Send one ClearML Serving request at its scheduled time."""
...
def run_load_test(
    ...
    """Run a fixed-rate load test against ClearML Serving."""
    ...
    print("Starting ClearML load test")
    print(f"URL: {url}")
    print(
        f"Target rate: "
    ...
    print()
    print("ClearML load test results")
    print(
        json.dumps(
            summary,
            indent=2,
